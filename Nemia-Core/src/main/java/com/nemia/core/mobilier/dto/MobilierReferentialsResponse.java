...
public class MobilierReferentialsResponse {
  ...
  public List<ReferentialItemResponse> getCategoriesMobilier() {
    return categoriesMobilier;
  }

  public List<ReferentialItemResponse> getEtatsUsage() {
    return etatsUsage;
  }

  public List<ReferentialItemResponse> getStatutsMobilier() {
    return statutsMobilier;
  }
}
