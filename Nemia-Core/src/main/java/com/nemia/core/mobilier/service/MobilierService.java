...
public class MobilierService {
  ...
  public MobilierService(MobilierRepository mobilierRepository, JustificatifRepository justificatifRepository) {
  ...
  public List<MobilierResponse> findAll(Long bienId) {
    ...
    List<Mobilier> liste = (bienId != null) ? mobilierRepository.findByBienId(bienId) : mobilierRepository.findAll();
  ...
  public MobilierResponse findById(Long id) {
    ...
    Mobilier mobilier = mobilierRepository
      .findById(id)
      .orElseThrow(() -> {
