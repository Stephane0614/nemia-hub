...
public class BienReferentialsResponse {
  ...
  public List<ReferentialItemResponse> getStatutActivites() {
    return statutActivites;
  }

  public void setStatutActivites(List<ReferentialItemResponse> statutActivites) {
    this.statutActivites = statutActivites;
  }

  public List<ReferentialItemResponse> getTypeLocations() {
    return typeLocations;
  }

  public void setTypeLocations(List<ReferentialItemResponse> typeLocations) {
    this.typeLocations = typeLocations;
  }

  public List<ReferentialItemResponse> getRegimeVises() {
    return regimeVises;
  }

  public void setRegimeVises(List<ReferentialItemResponse> regimeVises) {
    this.regimeVises = regimeVises;
  }
}
